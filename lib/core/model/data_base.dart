...
static CollectionReference<MessageModel> getMessageCollection(String roomID){
  return FirebaseFirestore.instance.collection(RoomModel.collectionName).doc(roomID).collection(MessageModel.collectionName)
...
static Future<void> insertMessage(MessageModel message)async{
  ...
  var documentReference= messageCollection.doc(); 
  // to create a new document inside the collection
